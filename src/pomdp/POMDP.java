...
public class POMDP {
    ...
    public static void main(String[] args) {
        ...
        String f = "C:\\Users\\Amine\\Documents\\NetBeansProjects\\POMDP\\results_1ACK\\";
        
        double min_range = 0.95; //min 1-beta
        double max_range = 1.0; //max 1-beta
        double min_diff_range = 0.8; //min 1-beta-alpha
        double max_diff_range = 0.95; //max 1-beta-alpha
        ...
        test_singleAck_channels2(folder_1ACK, min_range, max_range, min_diff_range, max_diff_range); /*this one*/
        ...
        //s.analyze_full_correlation_4D(f+"STATS_COMPLEX_1ACK_PPPP.txt", 1);
        //s.analyze_full_correlation_2D("C:\\Users\\Amine\\Documents\\NetBeansProjects\\POMDP\\comparison.txt", 1);
    ...
    static void test_singleAck_channels(String folder){
        ...
        double[] a  = {0.6, 0.85, 0.9, 0.4};
        double[] b  = {0.56, 0.3, 0.2};
        double[] cc = {0.4, 0.6};
        double[] d  = {0.33, 0.1};
        double[] e  = {0.9, 0.6, 0.3};
        double[] ff = {0.84, 0.5, 0.1};
        double[] g  = {0.79, 0.67, 0.55};
        double[] h  = {0.6, 0.4};
    ...
    static void test_singleAck_channels2(String folder, double min_range, double max_range, double min_diff_range, double max_diff_range){
        ...
        double p11_11, p11_01;
        double p12_11, p12_01;
        double p21_11, p21_01;
        double p22_11, p22_01;
        
        while(count < 1000){                        
            //Generate 1000 random alphas and bettas respecting ranges and correlations
            double _1mB = min_range + Math.random()*(max_range-min_range);
            double max = _1mB - min_diff_range;
            double min = Math.max(_1mB - max_diff_range, 0);
            //System.out.println("min: " + min + " max: " + max);
            double _a = min + Math.random() * (max-min);            
            p11_11 = _1mB; p11_01 = _a ;
            //System.out.println("p11_11: " + p11_11 + "p11_01: " + p11_01);
            
            _1mB = min_range + Math.random()*(max_range-min_range);
            max = _1mB - min_diff_range;
            min = Math.max(_1mB - max_diff_range, 0);
            //System.out.println("min: " + min + " max: " + max);
            _a = min + Math.random() * (max-min);            
            p12_11 = _1mB; p12_01 = _a ;                        
            //System.out.println("p12_11: " + p12_11 + "p12_01: " + p12_01);
            ...
            //System.out.println("min: " + min + " max: " + max);
            _a = min + Math.random() * (max-min);            
            p21_11 = _1mB; p21_01 = _a;                        
            //System.out.println("p21_11: " + p21_11 + "p21_01: " + p21_01);
            ...
            //System.out.println("min: " + min + " max: " + max);
            _a = min + Math.random() * (max-min);            
            p22_11 = _1mB ; p22_01 = _a;
            //System.out.println("p22_11: " + p22_11 + "p22_01: " + p22_01);
